...
function Booking() {
    ...
    const [patientEmail, setPatientEmail] = React.useState(email);
    const [doctorEmail, setDoctorEmail] = React.useState("default");
            ...
            <div className="booking-container">
                ...
                <div className="booking-right">
                    <div className="booking-form">
                        ...
                        <input className="booking-input" placeholder="patient email" type="email" value={email} onChange={(e) => { setPatientEmail(e.target.value) }} />

                        <select className="booking-input" placeholder="doctor info" onChange={(e) => { setDoctorEmail(e.target.value) }}>
                        <option value="default">Select Doctor</option>
                            {doctorsList.map((doctor) => (doctor &&
                                <option value={doctor.email}>{doctor.name} ( {doctor.specialisation} ) - {doctor.email}</option>
                            ))}
                        </select>
